...
jQuery(document).ready(function ($) {
    ...
    $(".submit").click(function () {
       ...
       var bloc = $(".bloc").val();
        ...
        if (fname == "" || date == "" || gender == "" || bloc == "" || Amessage == "" || gender == null)
            toastr["error"]("Please enter value for all the mandatory fields", "Invalid Data!!");
        else {
            ...
            xhr.onreadystatechange = function () {
                if (xhr.readyState == 4 && xhr.status == 200) {
                    toastr["error"](xhr.responseText, "Wait!!");
    ...
    function successfunctionauth2(x) {
        ...
        if (d[0].ProfileImageURL != null) {
            ...
            //alert(imgpath);
            //$('img#user-image').prop('href', imgpath);
...
function AnnouncementClicked(xx) {
    ...
    $.ajax({
        ...
        async: true,
        data: JSON.stringify({ "id": id }),//announcementID
        contentType: "application/json; charset=utf-8",
        type: 'post',
        datatype: 'json',
    ...
    function successfunctionClickAnn() {
        window.location.href = '/Registered/RegisteredIndividual1';
    }
}
...
function getUserAnnouncement(x) {

    $.ajax({
        url: "/Registered/getUserAnnouncement",
        async: true,
    ...
    function successfunctionShowAnn(x) {
        ...
        $.each(k, function (i, v) {
            adata = adata + '<div id="' + v + '" class="announcement-box"  style="border-top: 2px solid #E6ED1A;"><div class="announcement-head"><div class="announcement-author"><img src="../UserImages/' + ((iii++) % 10) + '.jpg" class="announcement-author-image"></img></div><div class="anoouncement-header-title"><h3>Condolances</h3></div><div class="read-more-icon" onClick="AnnouncementClicked(this);"><img src="../img/book.png" class="announcement-author-image"></img></div></div><div class="announcement-body"><img src="../img/Announcement/' + v + '.jpg" class="announcement-person-image"></img></div><div class="announcement-foot" style="border-bottom: 2px solid #E6ED1A;"><div id="regret-smiley-icon" onClick="RegretClick(this);"><img src="../img/sad39.png" class="icon" alt="telephone icon" /></div><div id="comment-box-icon"><img src="../img/speechbubble10.png" class="icon" alt="Mobile icon"></img></div><div id="lend-a-hand-icon"><img src="../img/hand-gesture.png" class="icon" alt="Email icon" /></div><div id="share-icon"><img src="../img/share11.png" class="icon" alt="Location icon" /></div></div></div>';
        ...
        getAllannouncement(adata);
    }
}

function getAllannouncement(adata) {
    $.ajax({
        url: "/Registered/getAllUserAnnouncement",
        async: true,
        contentType: "application/json; charset=utf-8",
        type: 'post',
        datatype: 'json',
    ...
    function successfunctionShowAnn(x) {
        ...
        $.each(k, function (i, v) {
            adata = adata + '<div id="' + v + '" class="announcement-box"><div class="announcement-head"><div class="announcement-author"><img src="../UserImages/' + ((iii++) % 10) + '.jpg" class="announcement-author-image"></img></div><div class="anoouncement-header-title"><h3>Condolances</h3></div><div class="read-more-icon" onClick="AnnouncementClicked(this);"><img src="../img/book.png" class="announcement-author-image"></img></div></div><div class="announcement-body"><img src="../img/Announcement/' + v + '.jpg" class="announcement-person-image"></img></div><div class="announcement-foot"  ><div id="regret-smiley-icon" onClick="RegretClick(this);"><img src="../img/sad39.png" class="icon" alt="telephone icon" /></div><div id="comment-box-icon"><img src="../img/speechbubble10.png" class="icon" alt="Mobile icon"></img></div><div id="lend-a-hand-icon"><img src="../img/hand-gesture.png" class="icon" alt="Email icon" /></div><div id="share-icon"><img src="../img/share11.png" class="icon" alt="Location icon" /></div></div></div>';
            //$('.announcement-container').append(adata);
            //alert(v);
        });
...
function getUserCreatedAnnouncement() {
    ...
    function successfunctionShowAnn(x) {
        var k = $.parseJSON(x);
        $.each(k, function (i, v) {
            var adata = '<div id="' + v + '" class="announcement-box"><div class="announcement-head"><div class="announcement-author"><img src="../UserImages/' + ((iii++) % 10) + '.jpg" class="announcement-author-image"></img></div><div class="anoouncement-header-title"><h3>Condolances</h3></div><div class="read-more-icon" onClick="AnnouncementClicked(this);"><img src="../img/book.png" class="announcement-author-image"></img></div></div><div class="announcement-body"><img src="../img/Announcement/' + v + '.jpg" class="announcement-person-image"></img></div><div class="announcement-foot"><div id="regret-smiley-icon" onClick="RegretClick(this);"><img src="../img/sad39.png" class="icon" alt="telephone icon" /></div><div id="comment-box-icon"><img src="../img/speechbubble10.png" class="icon" alt="Mobile icon"></img></div><div id="lend-a-hand-icon"><img src="../img/hand-gesture.png" class="icon" alt="Email icon" /></div><div id="share-icon"><img src="../img/share11.png" class="icon" alt="Location icon" /></div></div></div>';
            $('.announcement-container').append(adata);
        });
    }
